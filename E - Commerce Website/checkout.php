...
<section class="checkout-orders">
   ...
   <form action="https://razorpay.me/@mahesharjunsangule" method="POST">
   ...
   <h3>your orders</h3>
      ...
      <center>  
             <input type="submit" name="order" style="width:20%" class="btn <?= ($grand_total > 1)?'':'disabled'; ?>" value="PAY NOW">
      <center>
   </form>
