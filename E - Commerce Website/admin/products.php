...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      ...
      $insert_products = $conn->prepare("INSERT INTO `products`(name, details, price, image_01, image_02, image_03,image_04,image_05,image_06,type) VALUES(?,?,?,?,?,?,?,?,?,?)");
      $insert_products->execute([$name, $details, $price, $image_01, $image_02, $image_03, $image_04, $image_05, $image_06,$type]);
...
<head>
   ...
   <link rel="stylesheet" href="../css/admin_exstyle.css">
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="inputBox">
            ...
            <input type="text" class="box" required maxlength="100" placeholder="enter product name (tv/laptop/accessories/camera/fridge)" name="type">
         </div>
